...
export const UsersIcon = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.57-1.023-.194-1.37-1.022-1.37-1.93 0-2.5-1.238-2.5-2.5 0-1.263.67-2.5 2.5-2.5 1.83 0 2.5-1.237 2.5-2.5 0-1.262-.67-2.5-2.5-2.5S3 6.238 3 7.5v1.5M12 12.75a4.5 4.5 0 110-9 4.5 4.5 0 010 9z" />
  </svg>
);
...
export const HeartIcon = ({ className = "w-6 h-6", filled }) => (
...
export const UserGroupIcon = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.663M15 12.75h.007M15 12.75a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
...
export const BookmarkIcon = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.593 3.322c.1.121.1.287.1.442v18.068c0 .307-.21.574-.5.636a.501.501 0 01-.523-.06L12 16.59l-4.67 5.798a.5.5 0 01-.822-.534V3.764c0-.155.001-.321.1-.442.102-.122.24-.194.39-.194h9.38c.15 0 .288.072.39.194z" />
    </svg>
);
